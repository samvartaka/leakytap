# Underhanded Crypto Contest (UHC) 2015

| Submission Name        | Category        | Author     | License |
|:---------------|:---------------|:--------------|:--------------|
| LEAKYTAP | GPG Key Leaking Backdoor | Jos Wetzels | AGPL-V3 |

This relatively straight-forward GPG backdoor was my submission for the [2015 edition of the Underhanded Crypto Contest (UHC)](https://underhandedcrypto.com/2015/08/08/crypto-privacy-village-contest-winners/) of DEFCON's Crypto & Privacy Village. Due to time constraints the concept and code are a little rough but should prove interesting enough to anyone wanting to toy with backdoors in cryptographic software. Do also check out the [other submissions](https://underhandedcrypto.com/wp-content/uploads/2015/08/UHCCryptoVillage.tar.gz) to the contest.
